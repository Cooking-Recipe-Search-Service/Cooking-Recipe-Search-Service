...
export function clickManyTimes<T>(
    time: number,
    button: DebugElement,
...
export function findElByClass<T>(
    fixture: ComponentFixture<T>,
    classId: string,
): DebugElement {
    return queryByCss<T>(fixture, classId);
}
...
export function getTextByClass<T>(
    fixture: ComponentFixture<T>,
    classId: string,
): string {
    return findElByClass(fixture, classId).nativeElement.textContent;
}
...
export function expectTextByClass<T>(
    fixture: ComponentFixture<T>,
    testId: string,
    text: string,
): void {
    expect(getTextByClass(fixture, testId).trim()).toBe(text);
}
